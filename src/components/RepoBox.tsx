    ...
    <div>
      <div className="flex flex-col justify-between h-full lg:h-[700px] border-4 border-indigo-800 rounded-xl p-4">
        <div>
          ...
          <p className="text-indigo-700 text-sm text-center font-semibold mb-4">{description}</p>
          <p className="text-indigo-700 text-center font-bold mb-4">Projeto: {project}</p>
          <p className="text-indigo-700 text-center font-bold">{language}</p>
        </div>
