...
const Status = () => {
  return (
    <section className="mx-auto max-w-screen-xlxl container">
      <div className="flex flex-col lg:flex-row gap-5 items-center justify-center pl-0 lg:pl-72 py-10 w-full lg:w-[940px]">
      ...
      <div className="flex flex-col lg:flex-row gap-10 lg:gap-0 items-center justify-around w-[1569px] mx-auto">
        <div className="flex flex-col md:flex-row items-center gap-0 lg:gap-10 justify-around text-3xl md:w-full lg:w-[940px]">
          <div>
            ...
            <li className=" relative font-bold text-indigo-800 flex items-center gap-2 justify-start">
              ...
              <div className="bg-gray-500 w-72 h-6 relative rounded-xl">
                <div className="bg-pink-300 w-44 h-6 rounded-xl absolute top-0 left-0"></div>
              </div>
            </li>
          </div>
          <div className="flex flex-col list-none pt-0 md:pt-[60px]">
            ...
            <li className="relative font-bold whitespace-nowrap gap-1 text-indigo-800 flex items-center justify-start">
              ...
              <div className="bg-gray-500 w-72 h-6 relative rounded-xl">
                <div className="bg-pink-700 w-52 h-6 rounded-xl absolute top-0 left-0"></div>
              </div>
            </li>
          </div>
        </div>
      ...
      <div className="px-10 py-10">
        <div className="border-2 border-indigo-900 rounded-xl bg-indigo-200 px-2 py-2">
