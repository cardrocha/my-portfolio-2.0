...
const Project = () => {
  const projects: Repos[] = [
    ...
    },
    {
      ...
      description:
        'O projeto CartShop é uma aplicação web que demonstra um carrinho de compras simples. A aplicação é construída utilizando React.js, TypeScript, Tailwind CSS e gerenciamento de estado com Zustand. Totalmente responsivo, utilizando melhores prática de codificação e com feedback para o usuário ao fazer checkout, recebe dados da api para renderizar produtos que simula um e-commerce.',
      project: 'pessoal',
      language:
    ...
    },
    {
      ...
      description:
        'Este foi meu primeiro projeto de portfolio, nele utilizei parte do conhecimento adquirido no curso de React.js e Styled-componets: componentizção, ciclo de vida do componente, utilização de hooks do react, integrando-o ao framework Nest.js e ao tailwind css. Aqui, apresento tanto meus projetos pessoais quanto aqueles desenvolvidos durante o curso.',
      project: 'Pessoal',
    ...
    },
    {
      ...
      description:
        'Este projeto segue boas práticas de programação, estruturação de pastas organizada, código limpo e adota um design responsivo. Utilizando um design elaborado por Jonata Ferreira, aplico os conceitos aprendidos no curso para interpretar fielmente as referências do designer e implementá-las da melhor forma.',
    ...
    },
    {
      ...
      language: 'React - Redux-ToolKit, TypeScript, Styled-components, Formik - Yup - React-Input-Mask',
    ...
    },
    {
      ...
      description:
        'Projeto Portfólio simula uma provedora de internet banda larga ou fibra ótica. Este foi meu primeiro projeto de portfólio qual o fiz apenas html, css e js.',
      project: 'Pessoal',
  ...
  return (
    <section>
      <h2 className="text-4xl text-indigo-900 text-center mt-32 font-semibold border-b-4 border-indigo-800 pb-2">
        Meus Projetos
      </h2>
